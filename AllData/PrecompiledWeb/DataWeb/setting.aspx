<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="setting, App_Web_setting.aspx.cdcab7d2" title="栏目配置" %>
                ...
                <table style="width:100%;">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td class="style9">
                                        数据类型：</td>
                                    <td class="style8">
                                        <asp:DropDownList ID="ddlDataType" runat="server" OnSelectedIndexChanged="ddlDataType_SelectedIndexChanged" AutoPostBack="True">
                                        </asp:DropDownList>    
                                    </td>
                                    <td style="width:8px;">
                                        &nbsp;</td>
                                    <td class="style9">
                                        时间类型：</td>
                                    <td class="style21">
                                        <asp:DropDownList ID="ddlTimeType" runat="server" OnSelectedIndexChanged="ddlTimeType_SelectedIndexChanged">
                                            <asp:ListItem Value="选择数据时段"  Text="选择数据时段">
                                            </asp:ListItem>
                                        </asp:DropDownList>    
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="style21">
                            <table style="width:100%;">
                                <tr>
                                    <td class="style21">可选类型：</td>
                                    <td></td>
                                    <td class="style21">已选类型：</td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td rowspan="5" class="style3">
                                        <asp:ListBox ID="lboxDisplayAll" runat="server" Height="130px" Width="100px"></asp:ListBox>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td rowspan="5" class="style4">
                                        <asp:ListBox ID="lboxDisplaySelected" runat="server" Height="130px" 
                                ...
                                <tr>
                                    <td class="style1">
                                        <asp:Button ID="btAddDisplaySelected" runat="server" Text="&gt;&gt;" 
                                        onclick="btAddDisplaySelected_Click" />
                                    </td>
                                    <td style="width:8px;">
                                        &nbsp;</td>
                                    <td class="style21">
                                        <asp:Button ID="btDisplaySelectedUp" runat="server" Text="上移" 
                                        onclick="btDisplaySelectedUp_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1">
                                        <asp:Button ID="btDelFromDisplaySelected" runat="server" Text="&lt;&lt;" 
                                            onclick="btDelFromDisplaySelected_Click" />
                                    </td>
                                    <td class="style21">
                                        &nbsp;</td>
                                    <td class="style21">
                                        <asp:Button ID="btDisplaySelectedDown" runat="server" Text="下移" 
                                            onclick="btDisplaySelectedDown_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1">
                                        <asp:Button ID="btAddAllElement" runat="server" Text="All" 
                                            onclick="btAddAllElement_Click" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style21">&nbsp;</td>
                                    <td class="style21">&nbsp;
                                        <asp:Label ID="lbWDisplayReal" runat="server" ForeColor="#CC0000" 
                                            Text="* 请配置数据显示类型" Visible="False"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table style="width:100%;">
                                <tr>
                                    <td class="style10">站点选择：
                                        <asp:Label ID="lbPathname" runat="server"></asp:Label>
                                ...
                                <tr>
                                    <td class="style10">
                                        <asp:FileUpload ID="fuSelectStaFile" runat="server" Width="97%" />
                                    </td>
                                    <td class="style21">
                                        <asp:Button ID="btFromStaFile" runat="server" Text="导入" onclick="btFromStaFile_Click" />
                                    </td>
                                </tr>
                            </table>
                            <table style="width:100%;">
                                <tr>
                                    <td class="style5">
                                        <asp:Button ID="bOrder" runat="server" Text="按站点号排列" onclick="bOrder_Click" />
                                    </td>
                                    <td class="style21">
                                        &nbsp;</td>
                                    <td colspan="3" class="style21">
                                        <asp:Label ID="lbSelectedCity" runat="server" Text="已选城市列表："></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="5" class="style5">
                                        <asp:ListBox ID="lboxStationAll" runat="server" Height="220px" Width="140px" 
                                            onkeydown="javascript:spellList()"></asp:ListBox>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td rowspan="5" class="style7">
                                        <asp:ListBox ID="lboxStationReal" runat="server" Height="220px" Width="140px" 
                                            OnSelectedIndexChanged="lboxStationReal_SelectedIndexChanged" 
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btAdd2stationReal" runat="server" Text="&gt;&gt;" onclick="btAdd2stationReal_Click" />
                                    </td>
                                    <td class="style21">
                                        &nbsp;</td>
                                    <td class="style21">
                                        <asp:DropDownList ID="ddlStep1" runat="server"  OnSelectedIndexChanged="ddlStep1_SelectedIndexChanged" AutoPostBack="True">
                                            <asp:ListItem Text="上移格数" Value="上移格数">
                                            </asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Button ID="btDelStationReal" runat="server" Text="&lt;&lt;" onclick="btDelStationReal_Click" />
                                    </td>
                                    <td class="style21">
                                        &nbsp;</td>
                                    <td class="style21">
                                        <asp:DropDownList ID="ddlStep2" runat="server" OnSelectedIndexChanged="ddlStep2_SelectedIndexChanged" AutoPostBack="True">
                                            <asp:ListItem Text="下移格数" Value="下移格数">
                                            </asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="style21">
                                        &nbsp;</td>
                                    <td class="style21">
                                        <asp:Label ID="lbWStationReal" runat="server" ForeColor="#CC0000" 
                                            Text="* 请配置需要显示站点" Visible="False"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="bSet" runat="server" onclick="bSet_Click" Text="设置" />
                        </td>
                    </tr>
                </table>
            </td>
