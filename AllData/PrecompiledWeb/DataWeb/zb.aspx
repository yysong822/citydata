<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="zb, App_Web_zb.aspx.cdcab7d2" title="总表数据" %>
...
<table>
            <tr>
                <td>
                    ...
                    数据类型：<asp:DropDownList ID="ddl_dt" runat="server" AutoPostBack="True"  OnSelectedIndexChanged = "ddl_dt_SelectedIndexChanged">
                    </asp:DropDownList>
                    
                &nbsp;&nbsp;&nbsp;&nbsp;
                    
                    时间类型：<asp:DropDownList ID="ddl_tt" runat="server" AutoPostBack="True"  OnSelectedIndexChanged = "ddl_tt_SelectedIndexChanged">
                    </asp:DropDownList>
