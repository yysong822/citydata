<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="cpsetting, App_Web_cpsetting.aspx.cdcab7d2" title="频道配置" %>
...
<script type="text/javascript" language="javascript" >
    ...
    function moveItems(objfrom, objto) {
        var lbRight = document.getElementById(objfrom);
        var lbLeft = document.getElementById(objto);
