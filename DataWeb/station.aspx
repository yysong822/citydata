<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="station.aspx.cs" Inherits="station" Title="站点管理" %>
                                ...
                                <tr>
                                    ...
                                    <tr id="headDynRow" runat="server">
                                        ...
                                        <td class="style7">
                                            导出选项：</td>
                                        <td class="style2">
                                            <!-- radio改为服务器控件时，checked="checked"改为checked="true" -->
                                            <input id="rbExportAsResult" type="radio" checked="true" name="export" value="0" runat="server" />按结果
                                            <input id="rbExportAsSetting" type="radio" name="export" value="1" runat="server" />按配置
                                        </td>
                                        <td class="style2" colspan="4">提示：若需要栏目配置的站点顺序请选择“按配置”导出。</td>
                                        <td class="style2">
